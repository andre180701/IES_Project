...
public class RequestIdentifierController {
  ...
  @PostMapping("/client/requestIdentifier/check")
    public String requestIdentifierSubmit(@ModelAttribute InputRequestIdentifier inputRequestIdentifier, Model model) {
      ...
      CreditCard creditCard = new CreditCard(inputRequestIdentifier.getCardNumber(), inputRequestIdentifier.getCardName(), inputRequestIdentifier.getCardExpirationDate(), inputRequestIdentifier.getCardCountry(), inputRequestIdentifier.getCardCvv());
      System.out.println(creditCard);
      Identifier identifier = new Identifier(inputRequestIdentifier.getRegistration(), inputRequestIdentifier.getVehicleClass(), client, creditCard );
